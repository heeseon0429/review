...
public class PanelA extends JPanel{
	...
	JButton aBtn3 = new JButton(new ImageIcon("src\\kiosk\\imgs\\간장.jpg"));
	...
	void addLayout() {
		...
		aCenter.add(aBtn1); // 패널에 버튼 추가하기(후라이드치킨)
			...
			aBtn1.setBackground(Color.WHITE);				 // 배경색을 하얀색으로 설정
		...
		aCenter.add(aBtn2); // 패널에 버튼 추가하기(양념치킨)
			...
			aBtn2.setBackground(Color.WHITE);				 // 배경색을 하얀색으로 설정
		...
		aCenter.add(aBtn3); // 패널에 버튼 추가하기(간장치킨)
			...
			aBtn3.setBackground(Color.WHITE);				 // 배경색을 하얀색으로 설정
		...
		aCenter.add(aBtn4); // 패널에 버튼 추가하기(맵슐랭)
			...
			aBtn4.setBackground(Color.WHITE);				 // 배경색을 하얀색으로 설정
		...
		aCenter.add(aBtn5); // 패널에 버튼 추가하기(크리미양파치킨)
			...
			aBtn5.setBackground(Color.WHITE);				 // 배경색을 하얀색으로 설정
		...
		aCenter.add(aBtn6); // 패널에 버튼 추가하기(치요링치킨)
			...
			aBtn6.setBackground(Color.WHITE);				 // 배경색을 하얀색으로 설정
