      ...
      /*
       제어문 : 프로그램의 순서를 바꾸는 구문
        ...
        if : 조건을 만족하는 실행문을 실행후 if 문을 빠져나온다/
         ...
         - if (조건){        //조건1이 참일때, 실행문1을 실행
              실행문1;
              } else if (조건2){   //조건2가 참일때, 실행문2를 실행
              실행문2;
              } else if (조건3){   //조건3이 참일때, 실행문은 3를 실행
              실행문3;
              }.....
              } else{            //위의 모든 조건은 만족하지 않을때 실행문 10을 실행
              실행문10;
              } 
       */
		...
		if ( 3> 5 ) {  //조건이 false이므로 실행문내의 구문은 실행되지 않는다.
			System.out.println("안녕");
			System.out.println("방가");
		}
        System.out.println("======조건이 true=============");
        if ( 3> 5 ) {  //조건이 true이므로 실행문내의 구문은 실행되지 않는다.
    		System.out.println("안녕");
    	    System.out.println("방가");
        }
