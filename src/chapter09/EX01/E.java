...
//E 클래스는 A 클래스를 상속 받는다.	<<== A클래스의 모든 필드와 메소드를 돌려 받는다.
...
//		System.out.println(d);		//private		<<== 부모의 d필드
		
		System.out.println("==부모의 메소드 호출==");
		print1();		//부모 클래스의 메소드 호출
		print2();		//부모 클래스의 메소드 호출
		print3();		//부모 클래스의 메소드 호출
//		print4();		//부모 클래스의 메소드 호출
